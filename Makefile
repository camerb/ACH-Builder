# This Makefile is for the ACH::Builder extension to perl.
#
...
#     NAME => q[ACH::Builder]
#     PREREQ_PM => {  }
#     VERSION_FROM => q[lib/ACH/Builder.pm]
...
PARENT_NAME = ACH
DLBASE = $(BASEEXT)
VERSION_FROM = lib/ACH/Builder.pm
OBJECT = 
LDFROM = $(OBJECT)
LINKTYPE = dynamic
BOOTDEP = 
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/ACH/Builder.pm

# Where is the Config information that we are using/depend on
CONFIGDEP = $(PERL_ARCHLIB)$(DFSEP)Config.pm $(PERL_INC)$(DFSEP)config.h

# Where to build things
INST_LIBDIR      = $(INST_LIB)/ACH
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/ACH
...
TO_INST_PM = lib/ACH/Builder.pm

PM_TO_BLIB = lib/ACH/Builder.pm \
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=$(MAN3EXT) --perm_rw=$(PERM_RW) \
	  lib/ACH/Builder.pm $(INST_MAN3DIR)/ACH::Builder.$(MAN3EXT) 
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/ACH/Builder.pm blib/lib/ACH/Builder.pm 
